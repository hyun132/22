...
class NormalImgAdapter(private val items: MutableList<Uri> = ArrayList(), val context: Context) :
    RecyclerView.Adapter<NormalImgAdapter.ViewHolder>() {

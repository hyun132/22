package com.iium.iium_medioz.util.library
...
import com.iium.iium_medioz.util.extensions.setShadowColorIfAvailable
import com.iium.iium_medioz.util.pixel.dpFloat

class CardView@JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private fun updateUI() {
        background = MaterialShapeDrawable(ShapeAppearanceModel().withCornerSize(radius)).apply {
            ...
            strokeWidth = this@CardView.strokeWidth
            strokeColor = ColorStateList.valueOf(this@CardView.strokeColor)
        }

...
import com.iium.iium_medioz.databinding.ViewCalendarItemBinding
import com.iium.iium_medioz.model.feel.CalendarPreview
import com.iium.iium_medioz.util.common.OnChangeProp
...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private val innerLinearLayouts = (1..6).map {
        LinearLayout(context).apply {
            ...
            layoutParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, px(ITEM_HEIGHT_6ROW_DP), 0f)
        }
    }
    ...
    private val dividerGenerator = {
        View(context).apply {
            ...
            layoutParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, px(1), 0f)
        }
    }
    ...
    private val bottomBlur = View(context).apply {
        ...
        layoutParams = LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, px(16)).apply {

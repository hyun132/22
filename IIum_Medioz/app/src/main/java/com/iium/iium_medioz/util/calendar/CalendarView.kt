...
import com.iium.iium_medioz.util.calendar.adapter.MonthlyAdapter
import com.iium.iium_medioz.util.calendar.adapter.WeeklyAdapter
import com.iium.iium_medioz.util.common.OnChangeProp
import com.iium.iium_medioz.util.extensions.*
...
constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private val barPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = getColor(R.color.calendar_bar)
    }
    ...
    private val capsulePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = getColor(R.color.calendar_bar)
        setShadowLayer(12f, 0f, 0f, getColor(R.color.calendar_bar))
    }

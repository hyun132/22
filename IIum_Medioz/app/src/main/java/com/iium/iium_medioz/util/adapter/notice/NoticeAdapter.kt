package com.iium.iium_medioz.util.adapter.notice
...
import com.iium.iium_medioz.util.`object`.Constant.NOTICE_CONTENT
import com.iium.iium_medioz.util.`object`.Constant.NOTICE_CREATED
import com.iium.iium_medioz.util.`object`.Constant.NOTICE_TITLE
...
class NoticeAdapter (private val noticeList : List<Announcement>, private val context: Context)
    ...
    inner class ViewHolder (itemView: View? ) : RecyclerView.ViewHolder(itemView!!){
        ...
        val btn_go = itemView?.findViewById<ImageView>(R.id.img_notice_item_go)

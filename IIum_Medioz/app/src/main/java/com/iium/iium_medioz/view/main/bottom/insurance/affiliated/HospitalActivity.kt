...
import com.iium.iium_medioz.viewmodel.main.MainViewModel
...
class HospitalActivity : BaseActivity(), OnMapReadyCallback {
    ...
    private fun moveCameraFly(latLng: LatLng, changeZoomLevel: Boolean) {
        val currentZoom =
            if (changeZoomLevel) if (defaultZoomLevel == 0.0) mMap!!.cameraPosition.zoom else defaultZoomLevel else mMap!!.cameraPosition.zoom
        val cameraUpdate =

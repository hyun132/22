package com.iium.iium_medioz.util.adapter.cs
...
import com.iium.iium_medioz.util.`object`.Constant.COUN_CONTENT
import com.iium.iium_medioz.util.`object`.Constant.COUN_CREATED
import com.iium.iium_medioz.util.`object`.Constant.COUN_NAME
import com.iium.iium_medioz.util.`object`.Constant.COUN_TITLE
import com.iium.iium_medioz.view.main.bottom.mypage.cs.CsDetailActivity
...
class CounSelingAdapter(private val counseling : List<CounList>, val context: Context)
    ...
    inner class ViewHolder (itemView: View? ) : RecyclerView.ViewHolder(itemView!!){
        ...
        val coun_title = itemView?.findViewById<TextView>(R.id.tv_counseling_title)
        val coun_created = itemView?.findViewById<TextView>(R.id.tv_counseling_timestamp)
        val btn_go = itemView?.findViewById<ImageView>(R.id.img_go)
        ...
        fun bind(list: CounList, context: Context){
            ...
            btn_go?.setOnClickListener {
                val intent = Intent(context, CsDetailActivity::class.java)
